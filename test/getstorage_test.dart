...
import 'package:get_secure_storage/src/read_write_value.dart';
...
void main() async {
  ...
  test('newContainer', () async {
    final container1 = await GetSecureStorage.init(container: 'container1');
    await GetSecureStorage.init(container: 'newContainer');
    final newContainer = GetSecureStorage(container: 'newContainer');

    /// Attempting to start a Container that has already started must return the container already created.
    var container2 = await GetSecureStorage.init();
